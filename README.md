...
You can then execute your native executable with: `./target/school-reyfow-courses-1.0-SNAPSHOT-runner`
...
- Amazon SNS ([guide](https://quarkiverse.github.io/quarkiverse-docs/quarkus-amazon-services/dev/amazon-sns.html)):
